...
import { findCustomerByPhone, incrementVisitCount, createVisitHistory } from '../services/supabase';
...
const VisitForm = ({ onSuccess, onError }) => {
  ...
  const handleConfirmVisit = async () => {
    ...
    try {
      ...
      if (updateError) {
        onError('방문 횟수 업데이트 중 오류가 발생했습니다.');
        return;
      }
            ...
            <div className="customer-info">
              ...
              <div className="info-content">
                <div className="info-row">
                  ...
                  <span className="info-value">{customer.nickname || '미등록'}</span>
                </div>
